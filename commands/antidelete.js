  ...
  async execute(sock, msg, args) {
    ...
    if (!isOwner(msg)) {
      return sock.sendMessage(
        jid,
        { text: '❌ This command is restricted to the owner dumbass.' },
        { quoted: msg }
      );
    }
    ...
    if (mode === 'g' || mode === 'p') {
      ...
      return sock.sendMessage(
        jid,
        {
          text: `🗑️ Antidelete is now *ON*, resending to *${destLabel}*.`,
        },
        { quoted: msg }
      );
    }
